package com.kavinschool.gilded.rose.refactored.level1;
...
public class GildedRoseLevel1RefactoredTest {
    Item[] items;
    String expectedName;
    int expectedSellIn;
    int expectedQuality;
    ...
    public GildedRoseLevel1RefactoredTest(Item[] items, String expectedName, int expectedSellIn, int expectedQuality) {
        this.items = items;
    ...
    public void updateQuality() {
        GildedRoseLevel1Refactored app = new GildedRoseLevel1Refactored(items);
        app.updateQuality();
